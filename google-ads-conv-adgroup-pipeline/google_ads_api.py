...
class GoogleAdsAPI:
    ...
    def get_campaign_performance(
        ...
        query = f"""
        SELECT segments.conversion_action, segments.conversion_action_category, metrics.all_conversions, metrics.all_conversions_value, metrics.all_conversions_by_conversion_date, metrics.all_conversions_value_by_conversion_date, segments.click_type, ad_group.id, ad_group.name, campaign.id, customer.id, customer.resource_name, campaign.name,segments.date FROM ad_group
        WHERE 
